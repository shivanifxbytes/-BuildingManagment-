                ...
                <tbody>
                 <?php $no = 1; ?>
                  ...
                  <tr>
                   ...
                   <td>
                      <div class="btn-group">
                        <a class="btn btn-success" title="{{__('messages.edit')}}" href="{{ url('/') }}/addFlatType/{{ Crypt::encrypt($row->id) }}" style="margin:5px;" data-toggle="tooltip">{{__('messages.edit')}}</a> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
                         &nbsp;&nbsp;&nbsp;
                         <a class="btn btn-danger" title="{{__('messages.delete')}}" style="margin:5px;" href="{{ url('/') }}/delete/{{ Crypt::encrypt($row->id) }}"   data-toggle="tooltip">{{__('messages.delete')}}</a>
                      </div>
                    </td>
                   </tr>
                  @endforeach                 
