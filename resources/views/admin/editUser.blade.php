            ...
            <div class="panel-body">
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{$user[1]->name}}"  name="owner" placeholder="{{ __('messages.owner')}}" required>
                    </div>   
                    <div class="form-group">
                        <label for="flat_number">Flat Number</label>
                        <select name="flat_number" id="flat_number" class="form-control" >
                            @foreach($users as $key => $row)
                            @if($row->flat_number == $user[1]->flat_number)
                            <option value="{{$user[1]->flat_number}}" selected="selected">{{$user[1]->flat_number}}</option>
                            @else
                    ...
                    <div class="form-group">
                        ...
                        <input id="owner_mobile_no" type="text" class="form-control" name="owner_mobile_no" value="{{ $user[1]->mobile_number }}" required>              
                    </div> 
                    <div class="form-group">
                        <label>{{ __('messages.carpet_area')}}</label>
                        <input type="text" class="form-control" value="{{ $user[1]->carpet_area }}"  name="carpet_area" placeholder="{{ __('messages.carpet_area')}}" required>
                    </div>  
